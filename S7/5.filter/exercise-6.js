...
const oldLeaguers = streamers.filter(gamers => { 
    if (gamers.gameMorePlayed.includes("Legends")) {
 if ( gamers.age > 35 ) {
    gamers.gameMorePlayed = gamers.gameMorePlayed.toUpperCase()
}
return true;
    }
    return false;
